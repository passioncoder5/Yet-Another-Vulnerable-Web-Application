...
### This buggy web application contains vulnerability such as sqli,file upload vulnerability,xss,access control vulnerabilities,IDOR etc and built with low to medium security to enhance the knowledge of script kiddies
